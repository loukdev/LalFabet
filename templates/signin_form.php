...
<form id="inscription_form" method="post" action="?signin">
    ...
    <input type="password" name="cpt_password_verif" id="cpt_password_verif" value="<?php echo $this->get("cpt_password_verif")?>" /> <br />
    ...
    <input type="date" name="adh_date_naissance" id="adh_date_naissance"
        value="<?php if ($this->get("adh_date_naissance") == "")
											...
											echo $this->get("adh_date_naissance")?>" /> <br />

    <label for="adh_rue">Rue* :</label>
    <input type="text" name="adh_rue" id="adh_rue" value="<?php echo $this->get("adh_rue")?>" /> <br />
    ...
    <input type="text" name="adh_code_postal" id="adh_code_postal" value="<?php echo $this->get("adh_code_postal")?>" /> <br />
