...
<form id="inscription_form" method="post" action="?signin">
    ...
    <input type="password" name="cpt_password_verif" id="cpt_password_verif" value="<?php echo $this->get("cpt_password_verif")?>" /> <br /> <br />
    ...
    <input type="date" name="adh_date_naissance" id="adh_date_naissance"
        value="<?php if ($this->get("adh_date_naissance") == "")
						echo "jj/mm/aaaa";
                     else
						echo $this->get("adh_date_naissance")?>" /> <br /> <br />
    ...
    <input type="text" name="adh_ville" id="adh_ville" value="<?php echo $this->get("adh_ville")?>" /> <br /> <br />

    <label for="adh_telephone1">Téléphone 1* :</label>
    <input type="text" name="adh_telephone1" id="adh_telephone1" value="<?php echo $this->get("adh_telephone1")?>" /> <br />
    <label for="adh_telephone2">Téléphone 2 :</label>
    <input type="text" name="adh_telephone2" id="adh_telephone2" value="<?php echo $this->get("adh_telephone2")?>" /> <br />
    <label for="adh_telephone3">Téléphone 3 :</label>
    <input type="text" name="adh_telephone3" id="adh_telephone3" value="<?php echo $this->get("adh_telephone3")?>" /> <br /> <br />
